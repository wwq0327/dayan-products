...
articles.append({
    "slug": "0608-yilunwen-dati-taolou",
    "title": "中考语文议论文答题套路与满分公式 | 大衍语文店",
    "header_title": "中考语文议论文答题套路与满分公式",
    "description": "中考议论文阅读常见题型答题套路汇总，掌握论点概括、论据分析、论证方法判断与满分答题公式。",
    "body": """
    <h2>一、议论文阅读核心题型</h2>
    <p>中考议论文阅读主要考查以下四大题型：论点概括题、论据分析题、论证方法辨析题、语言赏析题。掌握每种题型的答题套路，就能稳稳拿到高分。</p>
    <h2>二、论点概括题答题套路</h2>
    <p><strong>题型特征：</strong>文章的中心论点是什么？/ 请概括本文的中心论点。</p>
    <div class="step-box"><strong>答题公式：</strong>论点 = 文章标题 + 首段关键句 + 末段总结</div>
    <p><strong>满分答案结构：</strong>本文论述了……（论题），作者认为……（核心观点）。</p>
    <blockquote>① 从标题提取：标题即论点的情况最常见<br>
    ② 从首段提取：首段往往提出问题引出论点<br>
    ③ 从末段提取：末段往往是结论性论点</blockquote>
    <h2>三、论据分析题答题套路</h2>
    <p><strong>题型特征：</strong>某段举了……例子，有什么作用？/ 论据能否替换，为什么？</p>
    <p><strong>满分答题公式：</strong>这个例子论证了……（分论点），具体有力地说明了……（与中心论点的关系）。</p>
    <blockquote>① 事实论据：举出具体事例，证明论点<br>
    ② 道理论据：引用名言定理，增强说服力<br>
    ③ 论证思路：提出问题→分析问题→解决问题</blockquote>
    <h2>四、论证方法辨析题答题套路</h2>
    <p><strong>题型特征：</strong>画线句用了什么论证方法？/ 这种方法有什么作用？</p>
    <blockquote>① 举例论证：用……事例，具体有力地论证了……<br>
    ② 道理论证：通过引用……，充分有力地论证了……<br>
    ③ 对比论证：将……与……对比，突出了……<br>
    ④ 比喻论证：将……比作……，生动形象地论证了……</blockquote>
    <h2>五、语言赏析题答题套路</h2>
    <p><strong>题型特征：</strong>某词语的表达效果？/ 能否删去？</p>
    <p><strong>满分答题公式：</strong>这个词的意思是……，在句中起到……作用，体现了议论文语言的准确性、严密性。若删去，则……，与事实不符。</p>
    <h2>六、满分公式汇总</h2>
    <blockquote><strong>论点概括：</strong>本文论述了____，作者认为____。<br>
    <strong>论据作用：</strong>论证了____，有力说明了____。<br>
    <strong>论证方法：</strong>用了____论证方法，充分论证了____。<br>
    <strong>词语赏析：</strong>意思____，作用____，体现了议论文语言特点。</blockquote>
    <blockquote>💡 提示：议论文答题关键在于找准论点、分清论证方法、套用公式。勤加练习，议论文阅读满分不是梦！</blockquote>
    """
})

articles.append({
    "slug": "yuwen-yuedu-yuedu-wx",
    "title": "语文阅读理解文本类型与解题策略 | 大衍语文店",
    "header_title": "语文阅读理解文本类型与解题策略",
    "description": "中考语文阅读理解有哪些文本类型？",
    "body": """
    <h2>一、常见文本类型</h2>
    <p>中考语文阅读主要涉及记叙文、说明文、议论文、文言文四种类型。</p>
    <h2>二、各类文本解题策略</h2>
    <blockquote>① 记叙文：抓六要素，品关键句，分析人物形象<br>
    ② 说明文：找说明对象，理清说明顺序，辨析说明方法<br>
    ③ 议论文：寻论点、析论据、评论证思路<br>
    ④ 文言文：释词义、译句子、析内容、悟主旨</blockquote>
    <blockquote>💡 提示：不同文本有不同阅读方法，针对性练习是关键。</blockquote>
    """
})

articles.append({
    "slug": "yuwen-yuedu-yuedu-zt",
    "title": "语文阅读主题分类与考点归纳 | 大衍语文店",
    "header_title": "语文阅读主题分类与考点归纳",
    "description": "中考语文阅读有哪些高频主题？",
    "body": """
    <h2>一、高频主题分类</h2>
    <p>中考阅读主题主要包括：亲情、成长、自然、社会、文化五大类。</p>
    <h2>二、各主题常考题型</h2>
    <blockquote>① 亲情类：情感体验、人物描写、细节理解<br>
    ② 成长类：启示感悟、人物评析、事件意义<br>
    ③ 自然类：景物描写、情感抒发、主旨把握<br>
    ④ 社会类：现象分析、观点评价、现实意义<br>
    ⑤ 文化类：传统继承、文化内涵、精神价值</blockquote>
    <blockquote>💡 提示：熟悉主题分类，答题更有方向。</blockquote>
    """
})

articles.append({
    "slug": "yuwen-yuedu-yuedu-cj",
    "title": "语文阅读冲刺阶段提分技巧 | 大衍语文店",
    "header_title": "语文阅读冲刺阶段提分技巧",
    "description": "最后冲刺阶段如何提升阅读分数？",
    "body": """
    <h2>一、冲刺阶段阅读提分策略</h2>
    <p>最后一个月是阅读提分的黄金期，掌握技巧可快速提分。</p>
    <h2>二、具体方法</h2>
    <blockquote>① 每天一套阅读，保持手感<br>
    ② 错题归类，找共性问题<br>
    ③ 背诵答题公式，形成条件反射<br>
    ④ 限时训练，提升答题速度<br>
    ⑤ 重点突破高频题型</blockquote>
    <blockquote>💡 提示：冲刺阶段不求量，求质，每做一套都要彻底弄懂。</blockquote>
    """
})

articles.append({
    "slug": "yuwen-yuedu-yuedu-mk",
    "title": "语文阅读默写与背诵技巧 | 大衍语文店",
    "header_title": "语文阅读默写与背诵技巧",
    "description": "如何高效背诵和默写古诗词文？",
    "body": """
    <h2>一、背诵的重要性</h2>
    <p>古诗词文是中考必考内容，背诵是得分的基础。</p>
    <h2>二、高效背诵方法</h2>
    <blockquote>① 理解记忆：先理解诗意再背诵<br>
    ② 关键词串联：抓住每句关键词<br>
    ③ 反复巩固：早晚各复习一次<br>
    ④ 手写默写：边写边背，双重记忆</blockquote>
    <blockquote>💡 提示：理解性默写是趋势，死记硬背已不够用。</blockquote>
    """
})

articles.append({
    "slug": "yuwen-yuedu-yuedu-hf",
    "title": "语文阅读会商与讨论答题技巧 | 大衍语文店",
    "header_title": "语文阅读会商与讨论答题技巧",
    "description": "阅读中的会商讨论题型怎么答？",
    "body": """
    <h2>一、会商讨论题的特点</h2>
    <p>这类题目开放性强，考查思维能力和表达能力。</p>
    <h2>二、答题方法</h2>
    <blockquote>① 亮观点：明确表达自己的看法<br>
    ② 找依据：从文中找出支撑自己观点的内容<br>
    ③ 做比较：与其他观点对比分析<br>
    ④ 总结述：综合以上给出结论</blockquote>
    <blockquote>💡 提示：观点新颖、论据充分、表达流畅是得高分的关键。</blockquote>
    """
})

articles.append({
    "slug": "yuwen-yuedu-yuedu-sw",
    "title": "语文阅读手写与表达提升方法 | 大衍语文店",
    "header_title": "语文阅读手写与表达提升方法",
    "description": "如何提升阅读理解的手写表达能力？",
    "body": """
    <h2>一、表达提升的重要性</h2>
    <p>阅读理解最终要靠书面表达呈现，表达能力直接影响得分。</p>
    <h2>二、提升方法</h2>
    <blockquote>① 规范书写：字迹工整，卷面整洁<br>
    ② 条理清晰：分点作答，层次分明<br>
    ③ 术语准确：使用规范的答题术语<br>
    ④ 完整作答：答案要完整，不遗漏要点</blockquote>
    <blockquote>💡 提示：平时练习就要注重表达规范化。</blockquote>
    """
})

articles.append({
    "slug": "yuwen-yuedu-yuedu-jk",
    "title": "语文阅读解题与考场应对策略 | 大衍语文店",
    "header_title": "语文阅读解题与考场应对策略",
    "description": "考场阅读有哪些应对策略？",
    "body": """
    <h2>一、考场阅读时间分配</h2>
    <p>合理的时间分配是考场阅读得分的保障。</p>
    <h2>二、应对策略</h2>
    <blockquote>① 先看题目，带着问题读文章<br>
    ② 按序作答，遇到难题先跳过<br>
    ③ 留出检查时间，确保不漏题<br>
    ④ 难题结合上下文找线索</blockquote>
    <blockquote>💡 提示：考场心态稳，才能发挥正常水平。</blockquote>
    """
})

articles.append({
    "slug": "yuwen-yuedu-yuedu-db",
    "title": "语文阅读读薄与读厚的方法 | 大衍语文店",
    "header_title": "语文阅读读薄与读厚的方法",
    "description": "如何做到把书读薄又把书读厚？",
    "body": """
    <h2>一、何为读薄</h2>
    <p>读薄是指抓住文章核心，提炼关键信息。</p>
    <h2>二、何为读厚</h2>
    <p>读厚是指拓展相关知识，深入理解背景。</p>
    <h2>三、具体做法</h2>
    <blockquote>① 读薄：划重点句、归纳段意、提炼主旨<br>
    ② 读厚：查背景资料、拓展相关阅读、深度思考</blockquote>
    <blockquote>💡 提示：读写结合，才是真正的阅读能力。</blockquote>
    """
})

articles.append({
    "slug": "yuwen-yuedu-yuedu-ys",
    "title": "语文阅读应试心理与情绪调节 | 大衍语文店",
    "header_title": "语文阅读应试心理与情绪调节",
    "description": "如何调节考场阅读时的心态？",
    "body": """
    <h2>一、考场常见心理问题</h2>
    <p>紧张、焦虑、慌乱是考场阅读的大敌。</p>
    <h2>二、情绪调节方法</h2>
    <blockquote>① 深呼吸：遇难题时深呼吸放松<br>
    ② 积极暗示：告诉自己我能行<br>
    ③ 暂时跳过：难题先放一放，回头再做<br>
    ④ 专注当下：只关注当前这道题</blockquote>
    <blockquote>💡 提示：心态好才能发挥好，心态本身就是竞争力。</blockquote>
    """
})

articles.append({
    "slug": "yuwen-yuedu-yuedu-zk",
    "title": "语文阅读主旨与意图精准把握 | 大衍语文店",
    "header_title": "语文阅读主旨与意图精准把握",
    "description": "如何准确把握文章的主旨和作者意图？",
    "body": """
    <h2>一、主旨把握的重要性</h2>
    <p>主旨是文章的灵魂，把握主旨是阅读的核心目标。</p>
    <h2>二、方法技巧</h2>
    <blockquote>① 标题入手：标题往往透露主旨<br>
    ② 首尾呼应：开头结尾往往有主旨句<br>
    ③ 关键议论：议论性语句往往是主旨所在<br>
    ④ 情感变化：抓住作者情感主线</blockquote>
    <blockquote>💡 提示：主旨把握准，阅读题就成功了一半。</blockquote>
    """
})
